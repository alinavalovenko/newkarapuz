                    ...
                    <div class="col-xs-12 col-sm-4">
                        <div class="kz-top-right-banner">
                            <img src="<?php echo $kz_right_top_banner; ?>"
                                 alt="<?php echo $kz_right_top_banner_alt; ?>"></div>
                            ...
                            <div class="kz-categories-banner">
                                <a href="<?php echo (empty($categories_banners[$i]['kz_home_category_link_text'])) ? '#' : $categories_banners[$i]['kz_home_category_link_text'];?>">
                                    <div class="category-banner-holder">
                                        <img src="<?php echo (empty($categories_banners[$i]['home_category_banner_img']['url'])) ? KARAPUZ_IMAGES . '/banners/cat-banner.png': $categories_banners[$i]['home_category_banner_img']['url'] ;?>" alt="<?php echo $categories_banners[$i]['kz_category_name_text'];?>">
            ...
            <div class="kz-bottom-banners-wrap">
                <div class="row">
                    <div class="col-xs-12 col-sm-6 col-md-6">
                        <img src="<?php echo (empty($bottom_banners['kz_home_left_banner_img']))? KARAPUZ_IMAGES . '/banners/cat-bottom-banner.jpg':$bottom_banners['kz_home_left_banner_img'] ;?>" alt="bottom left banner">
                    </div>
                    <div class="col-xs-12 col-sm-6 col-md-6">
                        <img src="<?php echo (empty($bottom_banners['kz_home_right_banner_img']))? KARAPUZ_IMAGES . '/banners/cat-bottom-banner.jpg':$bottom_banners['kz_home_left_banner_img'] ;?>" alt="bottom right banner">
                    </div>
                </div>
            </div>
        </div>
